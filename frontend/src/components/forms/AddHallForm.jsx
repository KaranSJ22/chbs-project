...
const AddHallForm = () => {
    const [form, setForm] = useState({ name: '', building: '', code: '' });
    ...
    return (
        <div className="max-w-md bg-white p-6 rounded shadow">
            <h2 className="text-xl font-semibold mb-6 text-gray-800">Add New Conference Hall</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label className="block text-gray-700 mb-1 font-medium">Hall Name</label>
                    <input
                        type="text" required
                ...
                <div>
                    <label className="block text-gray-700 mb-1 font-medium">Building Name</label>
                    <input
                        type="text" required
                        className="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-blue-500 outline-none"
                ...
                <div>
                    <label className="block text-gray-700 mb-1 font-medium">Hall Code</label>
                    <input
